    ...
    <div class="mt-6">
      <h3 class="font-medium">
        <a :href="'https://' + url" class="focus:outline-none" target="_blank">
          ...
          <HeadingSerif class="text-4xl group-hover:text-indigo-500">
            {{ title }}
          </HeadingSerif>
        </a>
      </h3>
      <p class="mt-2 text-zinc-400 uppercase">{{ description }}</p>
    </div>
    <span class="pointer-events-none absolute top-6 right-6 text-zinc-300 group-hover:text-white" aria-hidden="true">
